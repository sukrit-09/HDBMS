...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad, omnis.</p>
            <a href="Expert_Doctors.html" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <div class="box">
            ...
            <h3>bed facility</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ad, omnis.</p>
            <a href="Bed.php" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p class="text">Exceptional care, compassionate staff, clean facility, prompt service. Grateful for their professionalism and dedication to patient well-being. Highly recommended!</p>
        </div>
        ...
        <div class="box">
            ...
            <p class="text">Outstanding care, compassionate team, spotless facility, speedy service. Deeply appreciate their expertise and commitment to patient health. Highly endorse this hospital!</p>
        </div>
        ...
        <div class="box">
            ...
            <p class="text">Atención excepcional, personal compasivo, instalaciones limpias, servicio rápido. Agradecido por su profesionalismo y dedicación al bienestar del paciente. ¡Muy recomendado!</p>
        </div>
